...
var owl = $('.reveiw-carousel');
 owl.owlCarousel({
   ...
   loop: false,
   nav: false,
  //  navText: ['<svg xmlns="http://www.w3.org/2000/svg" width="24" height="16" viewBox="0 0 24 16" fill="none"> <path d="M23.3339 7.9987H2.59188M8.66722 14.6654L2.00061 7.9987L8.66728 1.33203" stroke="#FF4600" stroke-width="2"/> </svg>', '<svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none"> <path d="M5.66626 15.9987H26.4283M20.3331 22.6654L26.9996 15.9987L20.3329 9.33203" stroke="#FF4600" stroke-width="2"/> </svg>'],
   dots: false,
   autoWidth:true,
//    stagePadding: 20,
   responsive: {
