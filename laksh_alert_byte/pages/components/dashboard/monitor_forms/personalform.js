...
const personalform = ({networks,resetAllstate }) => {
          ...
          // let walletaddress = personalformData.walletadress.toLowerCase();
            ...
            if (watchedAddresses > 4) {
              ...
              fetch("https://alertbytes.com/put_alert", requestOptions)
                ...
                .then(async (data) => {
                  console.log("api hit");
                  await createMoralisStream(walletadress);
                  console.log(data);
          ...
          return (
            <>
             <div className="title-btn-div"> 
              ...
              <div className="monitor-form" id="form-personal">
                  ...
                  <div className="mdl-butns lg-butns">
                    ...
                    <Button className="btn btn-emp" onClick={resetAllstate} > Cancel </Button>
                  </div>
